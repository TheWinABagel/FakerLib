...
public class FilteredSlot extends SlotItemHandler {
    ...
    public FilteredSlot(ItemStackHandler handler, int index, int x, int y, Predicate<ItemStack> filter) {
        super(handler, index, x, y);
        this.filter = filter;
        this.index = index;
    }

    public FilteredSlot(ItemStackHandler handler, int index, int x, int y) {
